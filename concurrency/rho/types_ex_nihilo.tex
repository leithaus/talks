...
\newcommand{\ltquote}{\boldsymbol{\ulcorner}}
\newcommand{\rtquote}{\boldsymbol{\urcorner}}
\newcommand{\newkw}{\nu}
...
\newcommand{\tdropn}[1]{\rtquote #1 \ltquote}
...
\newcommand{\Typ}{\mathbin{Type}}
\newcommand{\QTyp}{\mathbin{\quotep{Type}}}

\newcommand{\pmatches}[3]{ #1, \quotep{#2} \vdash #3 }
\newcommand{\scompat}[2]{ #1 \sim #2 }
...
Given this discussion, we write $x \doteqdot y$ when $x$ and $y$ stand
in channel/co-channel relation. In the first system presented, $x
\doteqdot y \Leftrightarrow x \nameeq y$, while in the system with the comm-annihilation rule, $\quotep{P}
\doteqdot \quotep{Q} \Leftrightarrow \forall R . [ P \juxtap Q \red^* R ] \Rightarrow R \red^* 0$.
...
The encryption scheme, write it ${\mathcal
H}_{\mathcal E}$, of each ${\mathcal H}$ is required to satisfy the condition

\begin{equation*}
	x \doteqdot y \Rightarrow {\mathcal H}_{\mathcal E}(x,y)(x) \doteqdot {\mathcal H}_{\mathcal E}(x,y)(y)
\end{equation*}

That is, if $x$ and $y$ are in channel/co-channel relation, then their
encrypted versions also stand in channel/co-channel relation. Note:
this will not actually hide all communications on the channels. An
eaves-dropper could get lucky. It depends on the strength of the
encryption.

\begin{example}
	Let $T \triangleq \outputp{v_0}{v_1} \juxtap
	\prefix{v_1}{v_0}{\dropn{v_2}}$, and ${\mathcal H}_{\mathcal
	E}(x,y)(z) \triangleq
	T\substn{x}{v_0}\substn{y}{v_1}\substn{z}{v_2}$. Then, if $x
	\doteqdot y \Leftrightarrow x \nameeq y$, then ${\mathcal
	H}_{\mathcal E}$ satisfies the condition.
\end{example}

\infrule[null]{}{\varepsilon,\quotep{0} \vdash \quotep{0}}
\infrule[variable]{}{ \{ v \mapsto \quotep{P} \}, \quotep{P} \vdash v}
\infrule[lift]{\pmatches{\varrho}{P}{t}, \qquad \pmatches{\sigma}{Q}{u}, \qquad \scompat{\varrho}{\sigma}}
	{ \pmatches{\varrho : \sigma}{\lift{\quotep{P}}{Q}}{\quotep{\outputp{t}{u}}} }
\infrule[input]{\pmatches{\varrho}{P}{t}, \qquad \pmatches{\sigma}{Q}{u}, \qquad \scompat{\varrho}{\sigma}}
	{ \pmatches{\varrho : \sigma}{\prefix{\quotep{P}}{x}{Q}}{\quotep{\prefix{t}{v}{u}}} }
\infrule[parallel]
	{\pmatches{\varrho}{P}{t}, \qquad \pmatches{\sigma}{Q}{u}, \qquad \scompat{\varrho}{\sigma}}
	{ \pmatches{\varrho : \sigma}{P \juxtap Q}{\quotep{ \tdropn{t} \juxtap \tdropn{u}}} }

%\begin{thm}[matching] 
%	$T \asymp W, \pmatches{\varrho}{P}{\quotep{T}}, \pmatches{\sigma}{Q}{\quotep{W}}$
%\end{thm}

\subsection{Type judgment}

Now, for the type judgment rules. These rules are really a scheme,
instantiated by a given cryptographic function, ${\mathcal H}$.

\infrule[null]{}{0 : 0}
\infrule[drop]{}{\dropn{x} : \dropn{v}}
\infrule[lift]{\pmatches{\varrho}{P}{t}, \qquad Q : U}
	{ \lift{\quotep{P}}{Q} : \outputp{t}{\quotep{U}} }
\infrule[input]{\pmatches{\varrho}{P}{t}, \qquad Q : U}
	{ \prefix{\quotep{P}}{x}{Q} : \prefix{t}{v}{U} }
\infrule[comm]{\lift{x_0}{R} \juxtap P : \outputp{t}{u} \juxtap T, 
			   \qquad \prefix{x_1}{y}{Q} : \prefix{w}{v}{U}, \qquad \dropn{t} \asymp \dropn{w}}
	{ {\mathcal H}(x_0,x_1)(\lift{x_0}{R} \juxtap P \juxtap \prefix{w}{v}{U}) 
	: {\mathcal H}(t,w)(T \juxtap U \substn{u}{v}) }
\infrule[ind]{P : \dropn{v}, \qquad Q : U}
	{ P \juxtap Q : \dropn{v} \juxtap U }
